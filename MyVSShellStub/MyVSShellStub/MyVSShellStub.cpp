// MyVSShellStub.cpp : Defines the entry point for the application.
//

#include "stdafx.h"
#include "commctrl.h"
#include "ShellSection.h"
#include "MyVSShellStub.h"
...
int APIENTRY WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
	...
	nRetVal = StartWithCommandLine(lpwCmdLine, L"MyVSShellStub", nCmdShow, NULL, NULL);
